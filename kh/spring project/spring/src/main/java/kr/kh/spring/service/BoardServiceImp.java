...
public class BoardServiceImp implements BoardService {
	...
	@Override
	public boolean insertCommnet(CommentVO comment, MemberVO user) {
		if(user == null)
			return false;
		if(comment == null)
			return false;
	...
	@Override
	public int getBoardTotalCountCommentList(int co_bo_num) {
		return boardDao.selectBoardTotalCountCommentList(co_bo_num);
	}

	@Override
	public boolean deleteCommnet(CommentVO comment,MemberVO user) {
		if(comment == null)
			return false;
		if(user == null)
			return false;
	...
	@Override
	public boolean updateCommnet(CommentVO comment, MemberVO user) {
