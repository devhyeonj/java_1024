...
public class CourseServiceImp implements CourseService {
	...
	public void insertLecture() {
		...
		LectureVO lecture = new LectureVO(0, le_name, le_schedulre, le_point, le_class, le_year, le_term, le_pr_num);
	...
	public void updateLecture() {
		...
		System.out.print("지도교수번호 : ");
		String le_pr_num = scan.nextLine();
		LectureVO lecture = new LectureVO(le_num, le_name, le_schedulre, le_point, le_class, le_year, le_term,
				le_pr_num);
